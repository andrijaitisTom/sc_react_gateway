      ...
      <Fragment>
        <Modal show={this.props.show} clicked={this.props.clicked}>
          <div className={classes.container}>
            ...
            <div className={classes.header}>
              ...
              <div className={classes.validFor}>
                ...
                <span className={classes.validForValue}>
                  {" "}
                  <Timer finishTime={this.props.responseData[7]} />{" "}
                </span>
              </div>
            </div>
            ...
            <QrCode address={this.props.responseData[6]} />
            <div className={classes.address}>
              {" "}
              Address:
              <span className={classes.addressValue}>
                {" "}
                {this.props.responseData[6]}{" "}
              </span>
              <div className={classes.copyButtonContainer}>
                ...
                <div
                  ...
                  onClick={() =>
                    navigator.clipboard.writeText(this.props.responseData[6])
                  }
                >
                  Copy address
                </div>
