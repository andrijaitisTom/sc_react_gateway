...
import TimerTestRequest from './Timer/TimerTestRequest'
...
<div className={classes.validFor}>
    Valid for:
    <span className={classes.validForValue}><TimerTestRequest timeStamp = {JSON.stringify(this.props.responseData[6])}/>
     </span>
</div>
</div>
